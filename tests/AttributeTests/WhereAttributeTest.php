...
use Tests\TestClasses\Controllers\WhereTestController;

it('can apply where on each method of a controller', function (): void {
...
it('can apply where on a method', function (): void {
    $this->routeRegistrar->registerClass(WhereTestController::class);
...
it('can apply shorthand where', function (): void {
    $this->routeRegistrar->registerClass(WhereTestController::class);

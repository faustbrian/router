...
use Tests\TestClasses\Controllers\Resource\ApiResource1TestController;
use Tests\TestClasses\Controllers\Resource\ApiResource2TestController;
use Tests\TestClasses\Controllers\Resource\ResourceTestDomainController;
use Tests\TestClasses\Controllers\Resource\ResourceTestExceptController;
use Tests\TestClasses\Controllers\Resource\ResourceTestFullController;
use Tests\TestClasses\Controllers\Resource\ResourceTestMiddlewareController;
use Tests\TestClasses\Controllers\Resource\ResourceTestNamesArrayController;
use Tests\TestClasses\Controllers\Resource\ResourceTestNamesStringController;
use Tests\TestClasses\Controllers\Resource\ResourceTestOnlyController;
use Tests\TestClasses\Controllers\Resource\ResourceTestParametersController;
use Tests\TestClasses\Controllers\Resource\ResourceTestPrefixController;
use Tests\TestClasses\Controllers\Resource\ResourceTestShallowController;
...
it('can register resource with prefix', function (): void {
...
it('can register resource with middleware', function (): void {
...
it('can register resource with only default middleware', function (): void {
...
it('can register resource with domain', function (): void {
...
it('can register resource with names as string', function (): void {
...
it('can register resource with names as array', function (): void {
...
it('can register resource with all methods', function (): void {
...
it('can register resource with domain option', function (): void {
    $this->routeRegistrar
        ->group(
            ['domain' => 'http://test'],
...
it('can register resource with only few methods', function (): void {
    $this->routeRegistrar->registerClass(ResourceTestOnlyController::class);
...
it('can register resource without few methods', function (): void {
...
it('can register API resource', function (): void {
...
it('can register API resource 2', function (): void {
...
it('can register shallow resource', function (): void {
...
it('can register resource with modified parameters', function (): void {
